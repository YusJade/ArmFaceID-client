...
class FaceAnalyzer : public treasure_chest::pattern::Subject,
 ...
 public:
  ...
  struct AnalyzeResult {
    ...
    const seeta::FaceAntiSpoofing::Status status;
    const seeta::QualityResult integrity_res;
    const seeta::QualityResult pose_res;
    const seeta::QualityResult clarity_res;
    const seeta::QualityResult resolution_res;
  };

  struct AnalyzeMsg {
    std::vector<AnalyzeResult> res;
    SeetaImageData img;
  };
